...
export default function VideoSection({videoId, videoData}) {
  ...
  return (
    ...
    <div id="videoArea" className=" w-[90%] md:w-[55%] 2xl:max-w-[45%]">
        <iframe className="rounded-2xl w-[100%] h-[25vw] max-h-400px min-h-200px" src={`https://www.youtube.com/embed/${videoId}?&autoplay=1`} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
